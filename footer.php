...
<footer class="w-full bg-white text-gray-600">
    <div class="w-full max-w-inner mx-auto py-36 px-6">
        <div class="grid grid-cols-2">
            <div class="col-span-1">
                <h2 class="text-20 text-gray-700 font-bold"><?php bloginfo( 'name' ) ?> - <?php bloginfo( 'description' ) ?></h2>
                <a href="mailto:<?php echo get_option( 'admin_email' ) ?>" class="inline-block underline text-28 text-cyan-500"><?php echo get_option( 'admin_email' ) ?></a>
                <div class="flex items-center mt-24">
                    <div class="h-72 w-72 overflow-hidden rounded-full border border-slate-300">
                    ...
                    <div>
                        <h3 class="text-20 font-semibold ml-12 mb-2">林裕大（YutoHayashi）</h3>
                        <p class="text-gray-500 text-18"></p>
                    </div>
                </div>
            </div>
            <div class="col-span-1">
                <ul class="w-full flex justify-center border border-slate-500 rounded-full">
                ...
                <nav class="py-10 px-6">
                    <ul class="grid grid-cols-3 gap-1 text-14">
                        <?php foreach( $nav_options as $no ): ?>
                            <?php if( ! @$no[ 'expandable' ] ): ?>
                                <li class="font-bold">
                                    <a target="_blank" href="<?php echo $no[ 'href' ] ?>" class="text-gray-700 hover:text-cyan-500 hover:font-bold"><?php echo $no[ 'title' ] ?></a>
                                </li>
                            <?php else: ?>
                                <li class="font-bold">
                                    <?php echo $no[ 'title' ] ?>
    ...
    <hr />
    <small class="inline-block w-full text-14 text-center py-6">&copy;2022 YutoHayashi All Rights Reserved.</small>
</footer>
